...
{
    struct render_recording *recording = (struct render_recording *)user;
...
{
    struct render_order *order = (struct render_order *)user;
...
{
    struct byte_array_reader *reader = (struct byte_array_reader *)user;
