...
{
    struct disp *disp = (struct disp *)user;
    if (is_raw)
...
{
    struct render_ctx *render = (struct render_ctx *)user;
...
{
    const struct agent_state *state = (const struct agent_state *)user;
...
{
    struct compact_event_ctx *ctx = (struct compact_event_ctx *)user;
...
{
    struct repl_loop_ctx *ctx = (struct repl_loop_ctx *)user;
